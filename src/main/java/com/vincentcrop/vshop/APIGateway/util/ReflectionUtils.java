...
public final class ReflectionUtils {
    ...
    /**
     * this method will replace all field value of original to target only if target
    ...
    /**
     * this method will patch all field value of original to target only if target
     * field value is not null
     * if origin and target are not the same class then return false
     * 
    ...
    public static Example<?> getMatchAllMatcher(Object object) {
        try {
            ...
            for (Field field : fields) {
                ...
                if (fieldValue != null)
                    customExampleMatcher.withMatcher(fieldName,
